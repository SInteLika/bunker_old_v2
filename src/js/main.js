...
//         'Карта друга - Посчитайте игроков начиная с игрока по левую руку от вас, с 0 и до ' + number + ', как только вы дошли до этой цифры этот человек и есть ваш друг (себя самого считать не нужно)) - вы обязанный пойти с данным игроком в бункер.(это обременение действует только на вас.) Эту карту не обязательно использовать, но она по умолчанию активна, вы не можете проигнорировать её функционал.',
//         'Карта врага - Посчитайте игроков начиная с игрока по левую руку от вас, с 0 и до ' + number + ', как только вы дошли до этой цифры этот человек и есть ваш друг (себя самого считать не нужно)) - вы не можете войти в бункер с данным игрок.(это обременение действует только на вас.) Эту карту не обязательно использовать, но она по умолчанию активна, вы не можете проигнорировать её функционал',
//'Вы меняетесь с выбранным игроком хобби',
//'Меняет выбранному игроку хобби',
let card = {
    list: [
        ...
        'Вы меняетесь с выбранным игроком состоянием здоровья',
        'Вы меняетесь с выбранным игроком фобией',
        'Вы меняетесь с выбранным игроком деторождаемостью и дополнительной информацией',
        ...
        'Выберите двух игроков(можно и себя) они меняются состоянием здоровья',
        'Выберите двух игроков(можно и себя) они меняются фобией',        
        'Выберите двух игроков(можно и себя) они меняются деторождаемостью и дополнительной информацией',
        ...
        'Вскрывает возрастную характеристику выбронного игрока',
        ...
        'Вскрывает у всех игроков - деторождаемость и доп информацию',
        'У всех игроков меняется выбранная вами характеристика',
        'Вы можете перераздать  профессии всем игрокам',
        'Вы можете перераздать возрастную характеристику всем игрокам',
        'Вы можете перераздать телосложение всем игрокам',
        'Вы можете перераздать состояние здоровья всем игрокам',
        ...
        'Меняет выбранному игроку профессию',
        'Меняет выбранному игроку возрастную характеристику',
        'Меняет выбранному игроку телосложение',
        'Меняет выбранному игроку состояние здоровья',
        'Меняет выбранному игроку фобию',
        'Меняет выбранному игроку дополнительную информацию',
        'Меняет выбранному игроку багаж',
        'Меняет выбранному игроку черта характера',
...
4) ${getHealthStatus(bodySex.reduction)}

5) ${getPhobia()}

6) ${getAddInformation(bodySex.reduction, bodySex.sex.value)}
...
function getBodySex() {
    ...
    ${body.text} 
    ${height.text}`,
    reduction : height.value + body.value,
	sex : sex,
	}
}
